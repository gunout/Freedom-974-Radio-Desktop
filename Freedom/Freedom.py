...
class FreedomRadioApp(Gtk.Window):
    def __init__(self):
        ...
        # Liste des stations Freedom Réunion
        self.stations = {
            "Freedom 1": "http://freedomice.streamakaci.com/freedom.mp3",
            "Freedom 2": "http://freedomice.streamakaci.com/freedom2.mp3",
        }

        # Charger les préférences
        self.config_file = os.path.expanduser("~/.freedom_radio.conf")
    ...
    def apply_css(self):
        ...
        css = """
        window {
            background-color: #000033;  /* Fond bleu foncé */
        ...
        button:hover {
            background-color: #6666ff;  /* Bleu plus clair au survol */
        }
        scale trough {
            background-color: #333333;  /* Fond gris foncé pour la barre de volume */
        }
        scale highlight {
            background-color: #0000ff;  /* Bleu pour la partie remplie */
        }
        #play-stop-label {
            color: #ffffff;  /* Texte en blanc */
            font-size: 14px;
